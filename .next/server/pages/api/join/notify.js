...
const handler = async (req, res)=>{
    ...
    if (req.method === "POST") {
        ...
        try {
            await axios__WEBPACK_IMPORTED_MODULE_0___default().post(`${process.env.SENTRY_WEBHOOK}/joinus/application`, req.body, {
                headers: {
...
var __webpack_exports__ = __webpack_require__.X(0, [241], () => (__webpack_exec__(2259)));
